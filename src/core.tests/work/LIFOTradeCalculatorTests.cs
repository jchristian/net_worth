...
namespace core.tests.work
{
    public class LIFOTradeCalculatorTests
    {
        ...
        public void when_calculating_trades_and_there_are_no_selling_transactions()
        {
            ...
            var trades = new LIFOTradeCalculator().CalculateTradesForSingleSecurityInAccount(new[] { first_transaction, second_transaction });
        ...
        public void when_calculating_trades_and_there_is_a_perfect_match()
        {
            ...
            var trades = new LIFOTradeCalculator().CalculateTradesForSingleSecurityInAccount(new[] { first_transaction, second_transaction, third_transaction });
        ...
        public void when_calculating_trades_and_there_are_multiple_complicated_sells()
        {
            ...
            var trades = new LIFOTradeCalculator().CalculateTradesForSingleSecurityInAccount(new[]
                                                                                             {
                                                                                                 first_transaction, second_transaction, third_transaction, fourth_transaction,
                                                                                                 fifth_transaction, sixth_transaction, seventh_transaction
                                                                                             });
