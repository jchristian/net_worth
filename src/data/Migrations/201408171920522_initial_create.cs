    ...
    public partial class initial_create : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BrokerageTransactions", t => t.ClosingTransactionId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Lots", "BrokerageTransaction_Id", "dbo.BrokerageTransactions");
            ...
            DropIndex("dbo.Lots", new[] { "BrokerageTransaction_Id" });
