        ...
        execute: function() {
            TransactionService = (function () {
                ...
                TransactionService.prototype.getTransactions = function () {
                    return this.httpService.get('http://localhost:60239/api/transactions');
                };
                TransactionService.prototype.getTransactionsWithTrades = function () {
                    return this.httpService.get('http://localhost:60239/api/transactions?includeTrades=true');
                };
